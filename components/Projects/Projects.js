            ...
            <div className="flex flex-col py- justify-center h-full">
                ...
                >
                    ...
                    <h2 className="text-[1.65rem] font-medium md:max-w-lg max-w-sm mt-2 seq">
                        I'm engineering a projects that's all about simplicity with a powerful punch—creating a seamless and effective
                        solution that speaks volumes in user experience.{" "}
                    </h2>
                </div>
                <div
                    className={`${
